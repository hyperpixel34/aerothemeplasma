...
FocusScope {
    ...
    onFocusChanged: {
        if (!focus) {
            ...
            if(!hoverArea.containsMouse) currentIndex = 0;
        }
    }
    ...
    function currentRow() {
        ...
        return Math.floor(currentIndex / (1+Math.floor(width / itemGrid.cellWidth)));
    }
            ...
            GridView {
                ...
                Keys.onUpPressed: {
                    ...
                    if(tempIndex < 0) {
                        ...
                        while(repeater.getCurrentModel().count == 0 && !repeater.isRepeaterEmpty()) {
                            repeater.currentModelIndex--;
                        }
                        repeater.getCurrentModel().currentIndex = repeater.getCurrentModel().count-1;
                    } else {
                        currentIndex--;
                    }
                }
                ...
                Keys.onDownPressed: {
                    ...
                    if(tempIndex >= count) {
                        ...
                        repeater.getCurrentModel().currentIndex = 0;
                    } else {
                        currentIndex++;
                    }
                }
