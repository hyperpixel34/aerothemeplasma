            ...
            Loader {
                ...
                Component {
                    ...
                    PlasmaCore.FrameSvgItem {
                        ...
                        imagePath: Qt.resolvedUrl("svgs/viewitem.svg")
                ...
                states: [
                    ...
                    State {
                        name: "selected+hover"
                        when: hovered && plasmoid.configuration.iconHoverEffect

                        PropertyChanges {
                            target: frameLoader
                            prefix: {
                                if(!model.selected) return "hover";
                                if(model.selected) return "selected+hover";
                            }
                        }
                    }
                    /*State {
