...
{
	QColor defaultHighlight(55, 176, 255, 255); // This is the default blue color used for highlighting monochrome icons.
    ...
    for(int i = 0; i < image.height(); i++)
    {
        ...
        {
            if(qAlpha(line[j]) < 128) continue; // Skip mostly transparent pixels.
	...
	// Increase the saturation and value by a bit and then clamp the values in case it goes over 255. 
