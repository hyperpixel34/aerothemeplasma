...
Item {
    ...
    */
    ...
    PlasmaCore.FrameSvgItem {
        ...
        anchors.fill: parent
        anchors.leftMargin: main.showSeconds ? 0 : -units.smallSpacing //To compensate for the shorter width of the clock when seconds are disabled
        anchors.rightMargin:main.showSeconds ? 0 : -units.smallSpacing
        z: -1
