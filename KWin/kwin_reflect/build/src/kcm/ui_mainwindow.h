...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        kcfg_EnableTransparency = new QCheckBox(centralwidget);
        kcfg_EnableTransparency->setObjectName(QString::fromUtf8("kcfg_EnableTransparency"));
        kcfg_EnableTransparency->setMaximumSize(QSize(16777215, 16777215));
        kcfg_EnableTransparency->setChecked(true);

        gridLayout_3->addWidget(kcfg_EnableTransparency, 2, 1, 1, 2);
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        kcfg_EnableTransparency->setToolTip(QCoreApplication::translate("MainWindow", "Enables/disables the transparency of the entire theme. \n"
"NOTE: This setting does NOT affect compositing settings.", nullptr));
#endif // QT_CONFIG(tooltip)
        kcfg_EnableTransparency->setText(QCoreApplication::translate("MainWindow", "Enable transparency", nullptr));
