...
#include <memory>
#include "../../../../kdecoration/config/breezeconfigwidget.h"
...
struct qt_meta_stringdata_Breeze__ConfigWidget_t {
    QByteArrayData data[3];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Breeze__ConfigWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Breeze__ConfigWidget_t qt_meta_stringdata_Breeze__ConfigWidget = {
    {
QT_MOC_LITERAL(0, 0, 20), // "Breeze::ConfigWidget"
QT_MOC_LITERAL(1, 21, 13), // "updateChanged"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "Breeze::ConfigWidget\0updateChanged\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Breeze__ConfigWidget[] = {
...
QT_INIT_METAOBJECT const QMetaObject Breeze::ConfigWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<KCModule::staticMetaObject>(),
    qt_meta_stringdata_Breeze__ConfigWidget.data,
    qt_meta_data_Breeze__ConfigWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Breeze::ConfigWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Breeze__ConfigWidget.stringdata0))
