...
InternalSettings::InternalSettings( )
  : KConfigSkeleton( QStringLiteral( "smodrc" ) )
{
  ...
  KConfigSkeleton::ItemBool  *itemHideIcon;
  itemHideIcon = new KConfigSkeleton::ItemBool( currentGroup(), QStringLiteral( "HideIcon" ), mHideIcon, false );
  addItem( itemHideIcon, QStringLiteral( "HideIcon" ) );
  KConfigSkeleton::ItemBool  *itemHideCaption;
  itemHideCaption = new KConfigSkeleton::ItemBool( currentGroup(), QStringLiteral( "HideCaption" ), mHideCaption, false );
  addItem( itemHideCaption, QStringLiteral( "HideCaption" ) );
  KConfigSkeleton::ItemBool  *itemHideInnerBorder;
  itemHideInnerBorder = new KConfigSkeleton::ItemBool( currentGroup(), QStringLiteral( "HideInnerBorder" ), mHideInnerBorder, false );
  addItem( itemHideInnerBorder, QStringLiteral( "HideInnerBorder" ) );
}
