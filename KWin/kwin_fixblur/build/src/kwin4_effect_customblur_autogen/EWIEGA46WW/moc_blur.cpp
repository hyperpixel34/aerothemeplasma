...
QT_MOC_LITERAL(8, 98, 30), // "slotWindowFrameGeometryChanged"
QT_MOC_LITERAL(9, 129, 11), // "oldGeometry"
QT_MOC_LITERAL(10, 141, 32) // "slotWindowFinishUserMovedResized"

    },
    "KWin::BlurEffect\0slotWindowAdded\0\0"
    "KWin::EffectWindow*\0w\0slotWindowDeleted\0"
    "slotPropertyNotify\0atom\0"
    "slotWindowFrameGeometryChanged\0"
    "oldGeometry\0slotWindowFinishUserMovedResized"
};
...
void KWin::BlurEffect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->slotWindowFrameGeometryChanged((*reinterpret_cast< KWin::EffectWindow*(*)>(_a[1])),(*reinterpret_cast< const QRectF(*)>(_a[2]))); break;
        case 4: _t->slotWindowFinishUserMovedResized((*reinterpret_cast< KWin::EffectWindow*(*)>(_a[1]))); break;
        default: ;
        }
