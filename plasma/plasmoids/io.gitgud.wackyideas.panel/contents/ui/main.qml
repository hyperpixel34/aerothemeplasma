...
//BEGIN UI elements
    ...
    MouseArea {
        ...
        Accessible.description: i18nd("plasma_shell_org.kde.plasma.desktop", "UI-Konfiguration öffnen")
    ...
    PC3.ToolButton {
        ...
        text: isHorizontal ? i18nd("plasma_shell_org.kde.plasma.desktop", "Widgets hinzufügen…") : undefined
