...
ColumnLayout {
    ...
    RowLayout {
        ...
        spacing: isWin ? Kirigami.Units.smallSpacing : Kirigami.Units.iconSizes.small
        ...
        Layout.margins: isWin ? 0 : Kirigami.Units.iconSizes.small / 2
    ...
    Item {
        ...
        Layout.fillWidth: true
        Layout.preferredHeight: Kirigami.Units.iconSizes.small * 8
