...
Loader {
    ...
    readonly property int tooltipInstanceMaximumWidth: Kirigami.Units.iconSizes.small * 16
    ...
    Component {
        ...
        PlasmaComponents3.ScrollView {
            ...
            ListView {
                ...
                reuseItems: true
                //spacing: Kirigami.Units.iconSizes.small
            }
            ...
            DelegateModel {
                ...
                readonly property real estimatedWidth: (toolTipDelegate.isVerticalPanel ? 1 : count) * (toolTipDelegate.tooltipInstanceMaximumWidth) - Kirigami.Units.iconSizes.small
                readonly property real estimatedHeight: (toolTipDelegate.isVerticalPanel ? count : 1) * (toolTipDelegate.tooltipInstanceMaximumWidth / 2 + Kirigami.Units.iconSizes.small) - Kirigami.Units.iconSizes.small
